...
var ToolbarButton = function (props) {
    ...
    if (props.icon) {
        var iconButton = (react_1.default.createElement(IconButton_1.default, __assign({}, sharedProps, { "aria-label": props.label, color: props.active ? "primary" : "default", size: size }), props.icon));
        if (props.tooltip) {
            return react_1.default.createElement(Tooltip_1.default, { title: props.tooltip }, iconButton);
        }
        return iconButton;
    }
    if (props.component) {
